 ...
 * August 27, 2020 (IC/JD V1.54)
 *  (a) Removed redundant for loop from updateEditTab.
 *  (b) Moved the gridCellSize widget to settingsdialog as it made more sense
 *      there.
 *  (c) In select_custom_graph() fix the positioning of graphs whose width
 *	or height is equal to 0.
 *  (d) When a custom graph is read in, set the height and width widgets,
...
/*
 * Name:	MainWindow::set_Inferface_Sizes()
